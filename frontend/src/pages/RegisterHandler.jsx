...
export default function RegisterHandler() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true)
    try {
      await client.post('/auth/register/handler', {
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
            ...
            <div className="bg-abyss border border-ember/30 rounded-sm p-8">
              <div className="font-mono text-sm space-y-2 mb-6">
                ...
                <p className="text-ghost">&gt; to submit your HANDLER request</p>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="text-center mb-8">
            ...
            <GlitchText as="h1" className="font-mono font-bold text-3xl text-ember neon-ember-text mt-4 tracking-widest">
              HANDLER ENLISTMENT
            </GlitchText>
            <p className="font-mono text-xs text-ghost mt-2 tracking-wide">
              Handler accounts require administrator approval before access is granted.
            </p>
          </div>
