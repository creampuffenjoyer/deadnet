...
END $$""",
  ...
  CONSTRAINT uq_contract_org_flag UNIQUE (contract_id, org_id)
            ...
            "UPDATE users SET role = 'OPERATIVE' WHERE role = 'NETRUNNER'",
            "UPDATE users SET role = 'CONTRACTOR' WHERE role = 'SUPERVISOR'",
            "UPDATE users SET role = 'HANDLER' WHERE role = 'INSTRUCTOR'",
